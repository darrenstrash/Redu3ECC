...
#
		      ...
		      'lib/ecc_reductions/cover.cpp',
		      'lib/ecc_reductions/graph.cpp',
		      'lib/ecc_reductions/ecc.cpp',
		      'lib/ecc_reductions/adjacency_list.cpp',
		      'lib/ecc_reductions/ecc_to_vcc.cpp',

		     'extern/quick-cliques/AdjacencyListAlgorithm.cpp',
		     'extern/quick-cliques/Algorithm.cpp',
	         'extern/quick-cliques/CliqueTools.cpp',
		     'extern/quick-cliques/DegeneracyAlgorithm.cpp',
		     'extern/quick-cliques/DegeneracyTools.cpp',
		     'extern/quick-cliques/HybridAlgorithm.cpp',
		     'extern/quick-cliques/MemoryManager.cpp',
		     'extern/quick-cliques/TomitaAlgorithm.cpp',
		     'extern/quick-cliques/Tools.cpp',
...
if env['program'] == 'redu3ecc':
        ...
        env.Program('redu3ecc', ['app/redu3ecc.cpp']+libkaffpa_files+libmapping, LIBS=['gurobi_c++', 'gurobi95'])
#
if env['program'] == 'kaffpa':
        env.Append(CXXFLAGS = '-DMODE_KAFFPA')
        env.Append(CCFLAGS  = '-DMODE_KAFFPA')
        env.Program('kaffpa', ['app/kaffpa.cpp']+libkaffpa_files+libmapping, LIBS=[''])
#
if env['program'] == 'evaluator':
        env.Append(CXXFLAGS = '-DMODE_EVALUATOR')
        env.Append(CCFLAGS  = '-DMODE_EVALUATOR')
        env.Program('evaluator', ['app/evaluator.cpp']+libkaffpa_files, LIBS=[''])
#
if env['program'] == 'node_separator':
        env.Append(CXXFLAGS = ' -DMODE_NODESEP')
        env.Append(CCFLAGS  = ' -DMODE_NODESEP')
        env.Program('node_separator', ['app/node_separator_ml.cpp']+libkaffpa_files, LIBS=[''])
#
if env['program'] == 'label_propagation':
        env.Append(CXXFLAGS = '-DMODE_LABELPROPAGATION')
        env.Append(CCFLAGS  = '-DMODE_LABELPROPAGATION')
        env.Program('label_propagation', ['app/label_propagation.cpp']+libkaffpa_files, LIBS=[''])
#
